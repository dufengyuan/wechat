window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: 'ws://192.168.43.36:8088/ws',
	 ...
	 * 图片服务器地址
	 */
	imgServerUrl: 'http://192.168.43.151/group1/',
	...
	/** 封装消息提示框，默认mui的toast不支持居中和自定义icon，所以使用h5+
	 * @param {Object} msg
	 * @param {Object} type
	 */
	...
	setContactList: function(contactList) {
		...
		// console.log(plus.storage.getItem("contactList"));
	},
